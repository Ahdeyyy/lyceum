	...
	<div class="card-body my-2 shadow-lg ">
        ...
        <div class="form-control">
            <label class="label" for="body">
              ...
              <textarea name="body" id="body" class="textarea textarea-bordered h-24" placeholder="Enter the question body" required></textarea>
        </div>
        ...
        <div class="form-control">
            ...
            <input class="input input-bordered w-full max-w-xs" placeholder="B" type="text" name="answer" id="answer" required />
        </div>
        ...
        {/each}
            ...
            <div class="form-control">
                ...
                <input class="input input-bordered w-full max-w-xs" type="text" name="option-body" id="option-body" />
            </div>
            <div class="form-control">
                ...
                <input class="input input-bordered w-full max-w-xs" type="text" name="option-body" id="option-char" placeholder="A" />
            </div>
